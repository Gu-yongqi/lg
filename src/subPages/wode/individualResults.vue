      ...
      <view class="box_1 flex-col">
        <view class="group_2 flex-col">
          ...
          <view v-if="code==-1">
            ...
            <text class="text_2">个人认证失败</text>
            <text class="text_3">未通过原因：姓名与身份证不符</text>
          ...
          <view v-else-if="code==0">
            ...
            <text class="text_2">个人认证审核中</text>
            <text class="text_3">您已提交个人认证，请耐心等待认证结果</text>
            <view class="section_4 flex-row justify-between">
          ...
          <view v-else-if="code==1">
            ...
            <text class="text_2">个人认证成功</text>
            <text class="text_3">您已成功通过个人认证，如需变更可重新认证</text>
            <view class="section_4 flex-row justify-between">
