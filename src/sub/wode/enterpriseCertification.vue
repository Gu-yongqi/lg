      ...
      <view class="group_2 flex-col">
        <view class="block_1 flex-col">
          ...
          <view class="group_5 flex-row">
            ...
            <text class="text_6">品牌名称：</text>
            <!-- <view class="text-wrapper_2 flex-col">
              <text class="text_7">请填写</text>
            </view> -->
          ...
          <view class="group_6 flex-row">
            ...
            <!-- <view class="group_7 flex-col">
              <view class="group_8 flex-row justify-between">
                <text class="text_10">请选择省市区</text>
          ...
          <view class="group_10 flex-row">
            ...
            <text class="text_15">营业执照：</text>
            <view class="block_4 flex-col shangchuan">
              <!--              <view class="section_1 flex-col">
                <view class="section_2 flex-col justify-between">
                  <image
                    class="label_1"
                    referrerpolicy="no-referrer"
                    src="@/static/image/wode/paizhaoshangchuan.png"
                  />
                  <text class="text_16">拍照上传</text>
                </view>
              </view> -->
              ...
              <view class="sc2" v-for="(item, index) in imgList" :key="index">
                <image class="del" @click="del(index)" src="../../static/image/wode/shanchu.png" mode="">
                </image>
                <image class="Img3" :src="item" mode=""></image>
              </view>
              <!-- <image class="image_2" referrerpolicy="no-referrer"
			  	:src="img||'https://lanhu.oss-cn-beijing.aliyuncs.com/SketchPngdcaaf2cffc18996eb15af8ff3dcb4791f5b2d22a5d1ac12363b02cb412b57299'" /> -->
              <view class="image_2 sc2" v-if="imgList.length <1" @click="upload">
                <image style="width:300rpx;height:300rpx;border: 2rpx dashed #9f9f9f;" class="sc3" src="@/static/image/wode/paizhaoshangchuan.png" mode=""></image>
              </view>
            </view>
          </view>
          <view class="text">{{textImage}}</view>
          <text class="text_17">
            上传最新的营业执照，格式要求：原件照片、扫描件或者加盖公章的复印件，支持.ipg&nbsp;.jpeg&nbsp;.gif&nbsp;.png格式照片，大小不超过2M
          </text>
          <view class="group_11 flex-row justify-between">
            <button class="text-wrapper_4 flex-col" @click="black">
              <text class="text_18">取消</text>
            </button>
...
export default {
  ...
  methods: {
        ...
        success: (res) => {
          ...
          uni.uploadFile({
            ...
            success: res => {
              ...
              this.imgList = [];
              this.imgList.push('https://csweapp.saas.qianjiangcloud.cn' + img);
            }
          })
        }
      });
    ...
    submit() {
      ...
      if (this.name == '' || this.user == '' || this.picker == '' || this.add == '' || this.imgList.length ==
        0) {
        if (this.name == '') {
          this.textName = '企业名称不能为空'
        } else {
        ...
        uni.request({
          ...
          method: 'GET',
          data: {
            paramJson: { "userinfoCode": this.dataObj.userInfoCode, "userinfoType": 2, "userinfoCorp": this.name, "companyShortname": this.user, "provinceName": this.sheng, "provinceCode": "", "cityName": this.shi, "cityCode": "", "areaName": this.qu, "areaCode": "", "companyAddress": this.add, "userinfoCert2Url": this.imgList[0] }
          },
          success: res => {
            console.log(res);
            this.init();
            uni.navigateTo({
              url: '/subPages/wode/enterpriseResults'
            })
          }
        })
      }
    ...
    .group_2 {
      ...
      .block_1 {
        ...
        .group_10 {
          ...
          .block_4 {
            height: 300rpx;
            // background: url(https://lanhu.oss-cn-beijing.aliyuncs.com/SketchPng1105a3a273ed7c4cd217e185c8d144446bfa1fabd073791a36c18282c0e12e07) 100% no-repeat;
            width: 300rpx;
            margin-top: 20rpx;
        ...
        .text_17 {
          ...
          line-height: 28rpx;
          text-align: left;
          margin: 16rpx 0 0 184rpx;
        }

        .group_11 {
          width: 684rpx;
          height: 110rpx;
          margin: 434rpx 0 0 34rpx;
